...
#include "../../../../softrware/1-qt5.9.9/Examples/Qt-5.9.9/charts/chartthemes/themewidget.h"
...
void ThemeWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ThemeWidget *_t = static_cast<ThemeWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ThemeWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ThemeWidget.data,
      qt_meta_data_ThemeWidget,  qt_static_metacall, nullptr, nullptr}
};

 ...
 */
typedef struct td_subindex //子索引格式
{
    UNS8                    bAccessType;
    UNS8                    bDataType; /* Defines of what datatype the entry is 定义数据类型*/
    UNS32                   size;      /* The size (in Byte) of the variable 数据长度*/
    void*                   pObject;   /* This is the pointer of the Variable 变量的指针*/
} subindex;
